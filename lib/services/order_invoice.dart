...
class MakeOrderInvoiceReportPdf {
  Widget paddedText(
    final String text,
              ...
              children: [
                TableRow(
                  ...
                  children: [
                    ...
                    paddedText("Rate (Rs)", PdfColor.fromHex("F5F5F5")),
                    paddedText("Status", PdfColor.fromHex("F5F5F5")),
                    paddedText("Unit", PdfColor.fromHex("F5F5F5")),
                    paddedText("Amount (Rs)", PdfColor.fromHex("F5F5F5")),
                  ],
                ),
                ...data.map(
                  (e) {
                    double amount = e['rate'] * e['quantity'];
                    return TableRow(
                      children: <Widget>[
                        ...
                        paddedText("${e['rate']}", PdfColors.black),
                        paddedText(e['unit'], PdfColors.black),
                        paddedText(e['status'], PdfColors.black),
                        paddedText("$amount ", PdfColors.black),
                      ],
                    );
                  },
                ),
