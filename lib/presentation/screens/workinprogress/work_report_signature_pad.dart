...
class WorkReportSignaturePadPage extends StatefulWidget {
  const WorkReportSignaturePadPage({super.key});

  @override
  State<WorkReportSignaturePadPage> createState() =>
      _WorkReportSignaturePadPageState();
}

class _WorkReportSignaturePadPageState
    extends State<WorkReportSignaturePadPage> {
  ...
  Future onGeneratePdf(Size size, args) async {
    ...
    final file = await WorkReportPdfApi.generatePDF(
        name: args["name"],
        data: args['data'],
